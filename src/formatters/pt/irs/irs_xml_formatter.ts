...
class PTIRSFormatter {
  static async format(xml : string, capitalGains : CapitalGain[], dividends : Dividend[]) {
  ...
  static async _formatBrowserVersion(xml : string, capitalGains : CapitalGain[], dividends : Dividend[]) {
  ...
  static async _formatServerVersion(xml : string, capitalGains : CapitalGain[], dividends : Dividend[]) {
