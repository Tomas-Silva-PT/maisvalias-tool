import { DividendAnexoJQuadro8 } from "../../../../../models/dividend.js";
import { DividendTransaction } from "../../../../../models/transaction.js";

class PTAnexoJQuadro8Formatter {
  constructor() { }

  format(dividends: DividendTransaction[]): DividendAnexoJQuadro8[] {
    let result: DividendAnexoJQuadro8[] = [];
    ...
    for (const assetGroup of Object.values(dividendsByAsset)) {
      for (const yearGroup of Object.values(assetGroup)) {
        ...
        const dividendForIRS: DividendAnexoJQuadro8 = {
    ...
    result = result.reduce((acc: DividendAnexoJQuadro8[], curr: DividendAnexoJQuadro8) => {
...
export { PTAnexoJQuadro8Formatter };
