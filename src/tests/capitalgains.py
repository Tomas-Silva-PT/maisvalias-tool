from src import Statement, PTCapitalGainsFormatter, Trading212Parser, Transaction, AssetBuffer
import pandas as pd
import time
...
if __name__ == "__main__":
    ...
    formatter = PTCapitalGainsFormatter()
    capital_gains = formatter.format(statement, "2023")
