...
|:-----------------|:----------:|:-----|
|       Ganhos de capital         |     🟢       |       |
|        Dividendos               |     🔴       |    Não existiu ainda possibilidade de testar o carregamento de um extrato com dividendos   |
|        Juros                    |     🔴      |   Não existiu ainda possibilidade de testar o carregamento de um extrato com juros de capital    |

O seguinte guia vai ensinar-te, passo a passo, como calcular automaticamente as tuas mais valias obtidas através da XTB.
