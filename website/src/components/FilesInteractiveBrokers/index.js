...
const broker = [
  {
    ...
    logo: "/img/brokers/interactivebrokers.png",
    active: true,
    docs: [
      {
...
export default function FilesInteractiveBrokers({ id, setFiscalData }) {
      ...
      content = (
        <>
          ...
          <p>
            ...
            <a href="docs/corretoras/interactivebrokers" target="_blank">
              documentação
            </a>{" "}
            e tenta novamente.
          </p>
  ...
  async function onFilesSelected() {
    ...
    const brokerParser = new InteractiveBrokersParser();
